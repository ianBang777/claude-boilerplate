...
1. `{WORKSPACE_PATH}/plan-overview.md` — 전체 아키텍처 및 BE와의 인터페이스
2. `{WORKSPACE_PATH}/plan-fe.md` — FE 작업 항목 및 수용 기준

### 출력

작업 완료 후 `{WORKSPACE_PATH}/fe-dev-output.md`에 저장:

```markdown
# FE 개발 결과

## 완료한 작업
[plan-fe.md 작업 항목 대비 완료 내역]
...
추가 요청 발생 시:
1. `{WORKSPACE_PATH}/fe-dev-output.md` 읽기
2. 변경 사항 반영
